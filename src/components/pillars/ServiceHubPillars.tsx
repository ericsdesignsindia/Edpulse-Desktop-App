...
export const ServiceHubPillars: React.FC<{
  ...
  const handleGenerateAiCopy = async () => {
    ...
    try {
      ...
      setGeneratedCopy(
        `## 🎯 Key Strategy Blueprint: ${aiTopic}\n\n` +
        `### Overview\nTo achieve maximum impact with **${aiType}**, align value propositions with customer pain points.\n\n` +
        `### Core Pillars\n` +
        `1. **Value Offer**: Clearly articulate immediate ROI.\n` +
        `2. **Social Proof**: Case studies showing 3.8x pipeline growth.\n` +
        `3. **Conversion Call to Action**: Direct booking link with low friction.\n\n` +
        `*Generated by EDPulse AI Strategy Engine.*`
      );
    } catch (err: any) {
      setGeneratedCopy(
        `## 🎯 Key Strategy Blueprint: ${aiTopic}\n\n` +
